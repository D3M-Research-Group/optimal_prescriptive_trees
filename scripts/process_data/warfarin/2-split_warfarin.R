...
fp <- readLines("global_file_path.txt")
...
for(data_seed in c(1,2,3,4,5)){
  for(r in c(1,2,3)){
    ...
    path = paste(fp, "data/processed/warfarin_intermediate/seed",toString(data_seed),"/",sep = "")
    data_path = paste(fp, "data/processed/warfarin/seed",toString(data_seed),"/",data_list[r],sep = "")
    data_enc_path = paste(fp, "data/processed/warfarin/seed",toString(data_seed),"/",data_enc_list[r],sep = "")
